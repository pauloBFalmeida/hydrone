...
kmax = 2;      % Number of iterations (generations)
...
for i = 1:np
    while VFi(i,1) == 0
        ...
        [VFi(i,1),VFi(i,2),VFi(i,3),VFi(i,4)] = F_LabH2_aprox_no_cav_lim(V_S, Xi(i,1),Xi(i,2),Xi(i,3),Xi(i,4));
...
for k = 1:kmax
    ...
    for i = 1:np
        ...
        [VFpo(i,1),VFpo(i,2),VFpo(i,3),VFpo(i,4)] = F_LabH2_aprox_no_cav_lim(V_S, xpo(i,1),...
