...
from F_SWResist import F_SWResist
from F_ProFac import F_ProFac
from F_ProPer_return_constraints import F_ProPer_return_constraints
from F_ProPer_return_constraints_numba import F_ProPer_return_constraints_numba

def F_LabH2_return_constraints(V_S, D, Z, AEdAO, PdD, use_numba=True):
# LabH2_F computes the brake power and shaft speed for given propeller parameters
    ...
    Rtotal, C_B, C_P, S, apk1, C_F, C_A, Fn, i_E = F_SWResist(L, B, T_F, T_A, nabla, LCB, A_BT, h_B, C_M, C_WP, A_T, S_APP, apk2, Cstern, V_S)
    ...
    t, w, etaR = F_ProFac(L, B, C_B, C_P, C_M, T_F, T_A, LCB, S_APP, S, apk1, apk2,C_F, C_A, Cstern, D, AEdAO, PdD, zP)
    ...
    try:
        if use_numba:
            [n,P_O,etaO, t075dD,tmin075dD, tal07R,cavLim, Vtip,Vtipmax] = F_ProPer_return_constraints_numba(Rtotal,V_S,t,w,etaR,zP,Z,D,PdD,AEdAO,hk,T_A)
        else:
        ...
        etaS = 0.99  # shaft efficiency []
        etaGB = 1  # gearbox efficiency []
